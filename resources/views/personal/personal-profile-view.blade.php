...
<div class="row">
    <div class="col-md-12">
        <h2 class="page-title">{{ __('Employee Profile') }}
            ...
            <a href="{{ url('personal/profile/edit') }}" class="btn btn-success ui basic blue button mini offsettop5 float-right"><i class="ui icon chevron left"></i>{{ __('Add Profile') }}</a>
        </h2>
    </div>    
</div>
