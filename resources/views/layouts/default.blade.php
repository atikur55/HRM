        ...
        <div class="sidebar-wrapper sidebar-theme">
            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    <li class="menu">
                        <a href="{{url('schedules')}} " aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                   ...
                   {{--  <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="app" data-parent="#accordionExample">
                            <li>
                                <a href="{{url('clock')}}"> Clock In/Out </a>
                            </li>
                            <li>
                                <a href="{{url('employees/new')}}"> New Employee </a>
                            </li>
                            <li>
                                <a href="{{url('fields/company')}}"> Company</a>
                            </li>
                            <li>
                                <a href="{{url('fields/department')}}"> Department </a>
                            </li>
                            <li>
                                <a href="{{url('fields/jobtitle')}}">Job Title</a>
                            </li>

                            <li>
                                <a href="{{url('fields/leavetype')}}"> Leave Type </a>
                            </li>
