                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="app" data-parent="#accordionExample">
                            <li>
                                <a href="apps_chat.html"> Clock In/Out </a>
                            </li>
                            <li>
                                <a href="apps_mailbox.html"> New Employee  </a>
                            </li>
                            <li>
                                <a href="apps_todoList.html"> Company</a>
                            </li>                            
                            <li>
                                <a href="apps_notes.html"> Department </a>
                            </li>
                            <li>
                                <a href="apps_scrumboard.html">Job Title</a>
                            </li>
                            <li>
                                <a href="apps_contacts.html"> Leave Type </a>
                            </li>
