        ...
        <header class="header navbar navbar-expand-sm">
            ...
            <ul class="navbar-item theme-brand flex-row  text-center">
                ...
                <li class="nav-item theme-text">
                    <a href="{{url('client/dashboard')}}" class="nav-link">client Area </a>
                </li>
            </ul>
              ...
              --}}
                ...
                <li class="nav-item dropdown user-profile-dropdown">
                    ...
                    <div class="dropdown-menu position-absolute" aria-labelledby="userProfileDropdown">
                        <div class="">
                            <div class="dropdown-item">
                                <a href="{{url('client/profile/view')}}">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-user">
                                        <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path>
                                        <circle cx="12" cy="7" r="4"></circle>
                                    </svg> Update Profile</a>

                                    {{-- <a href="{{ url('client/update-user') }}">
                                       Update Profile</a>

                                       <a href="{{ url('client/update-password') }}">
                                        Change Password</a> --}}
                ...
                <li>
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{url('dashboard')}}">Client Area</a></li>
        ...
        <div class="sidebar-wrapper sidebar-theme">
            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    <li class="menu">
                    <a href="{{ url('client/dashboard') }}" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu">
                        <a href="{{ url('client/project') }}" aria-expanded="false" class="dropdown-toggle">
                                <div class="">
                    ...
                    <!-- Atik Update End -->
                    <li class="menu">
                        <a href="{{ url('client/contact') }}" aria-expanded="false" class="dropdown-toggle">
                                <div class="">
