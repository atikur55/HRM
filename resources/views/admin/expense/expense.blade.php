    ...
    @section('content')
        ...
        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
            <div class="widget-content widget-content-area br-6">
                ...
                <a href="{{url('expense_category')}}" class="btn btn-warning btn-sm">Manage Expense Category</a><br>
                        ...
                        <div class="form-row">
                            <div class="col-md-3">
                                ...
                                <select name="expensecategory" class="form-control" required>
                                    ...
                                    @foreach($cat as $d)
                                <option value="{{$d->id}}">{{$d->expense_category_name}}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="expensecomment" class="form-control" required>
                            </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ url('expensedelete/'.$exp->id) }}" onclick="return confirm('are you sure?')" class="btn btn-danger">
