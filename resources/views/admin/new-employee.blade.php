                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="field">
                                    ...
                                    <input type="text" class="form-control" name="mi" value="">
                                </div>
                            </div>
                            <div class="field">
                            ...
                            <div class="form-group">
                                <div class="field">
                                    ...
                                    <input type="number" class="form-control" name="height" value="" placeholder="000">
                                </div>
                                <div class="field">
                                    <label>{{ __('Weight') }} <span class="help">(pounds)</span></label>
                                    <input type="number" class="form-control" name="weight" value="" placeholder="000">
                                </div>
                            </div>
                            <div class="form-group">
                            <div class="field">
                                <label>{{ __('Email Address (Personal)') }}</label>
                                <input type="email" name="emailaddress" value="" class="lowercase form-control">
                            </div>
                            <div class="field">
                            ...
                            <div class="form-group">
                                <div class="field">
                                    <label>{{ __('Age') }}</label>
                                    <input type="number" class="form-control" name="age" value="" placeholder="00">
                                </div>
                                <div class="field">
                                    <label>{{ __('Date of Birth') }}</label>
                                    <input type="date" name="birthday" value="" class="form-control airdatepicker" data-position="top right" placeholder="Date"> 
                                </div>
                            </div>
                            <div class="field">
                                <label>{{ __('National ID') }}</label>
                                <input type="text" class="form-control" name="nationalid" value="" placeholder="">
                            </div>
                            <div class="field">
                                <label>{{ __('Place of Birth') }}</label>
                                <input type="text" class="form-control" name="birthplace" value="" placeholder="City, Province, Country">
                            </div>
                            <div class="field">
                                <label>{{ __('Home Address') }}</label>
                                <input type="text" class="form-control" name="homeaddress" value="" placeholder="House/Unit Number, Building, Street, City, Province, Country">
                            </div>
                            <div class="field">
                                <label>{{ __('Upload Profile photo') }}</label>
                                <input class="ui file upload form-control" value="" id="imagefile" name="image" type="file" accept="image/png, image/jpeg, image/jpg" onchange="validateFile()">
                            </div>
                            <br>
                        </div>
                    </div>
                    ...
                    <div class="box box-success">
                        ...
                        <div class="box-body">
                            ...
                            <div class="field">
                                ...
                                <input type="email" name="companyemail" value="" class="lowercase form-control">
                            </div>
                            <div class="field">
                            ...
                            <div class="field">
                                ...
                                <input type="text" name="startdate" value="" class="airdatepicker form-control" data-position="top right" placeholder="Date">
                            </div>
                            <div class="field">
                                <label>{{ __('Date Regularized') }}</label>
                                <input type="text" name="dateregularized" value="" class="airdatepicker form-control" data-position="top right" placeholder="Date">
                            </div>
                            <br>
                        </div>
                    </div>
