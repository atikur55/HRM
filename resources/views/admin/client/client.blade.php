                    ...
                    <table id="zero-config" class="table table-hover" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr >
                                <td>{{ $client->id }}</td>
                                <td >
                                    @if($client->client_priority == 'high')
                                        <span style="" class="badge outline-badge-danger shadow-none">{{ $client->client_priority }}</span>
                                     
                                    @endif
                                    @if($client->client_priority == 'middle')
                                        <span style="" class="badge outline-badge-warning shadow-none">{{ $client->client_priority }}</span>
                                    @endif
                                    @if($client->client_priority == 'low')
                                        <span style="" class="badge outline-badge-info shadow-none">{{ $client->client_priority }}</span>
                                    @endif
                                ...
                                <td>
                                    ...
                                    <a href="{{ url('/client/edit/'.$client->id) }}" class="ui circular basic icon button tiny">
                                    ...
                                    <a href="{{ url('/client/delete/'.$client->id) }}" class="ui circular basic icon button tiny" onclick="return confirm('Are you sure?')">
