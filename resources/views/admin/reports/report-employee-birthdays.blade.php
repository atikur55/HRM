    ...
    <div class="container-fluid">
        ...
        <div class="col-md-12">
            <h2 class="page-title">{{ __("Employee Birthdays") }}
                <a style="margin-left:20px" href="{{ url('export/report/birthdays') }}" class="btn btn-success ui basic button mini offsettop5 btn-export float-right"><i class="ui icon download"></i>{{ __("Export to CSV") }}</a>
