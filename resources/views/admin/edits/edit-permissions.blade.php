        ...
        <div class="row">
            <div class="col-md-12">
                <h2 class="page-title">{{ __("Edit Permissions") }}
                    <a href="{{ url('users/roles') }}" class="btn btn-primary ui basic blue button mini offsettop5 float-right"><i class="ui icon chevron left"></i>{{ __("Return") }}</a>
                </h2>
            </div>
        </div>
            ...
            <div class="item">
                <div class="ui child checkbox slider">
                    ...
                    <div class="box-footer">
                        ...
                        <button class="btn btn-primary ui positive approve small button" type="submit" name="submit"><i class="ui checkmark icon"></i>{{ __("Set Permission") }}</button>
                        <a href="{{ url('users/roles') }}" class="btn btn-danger ui grey cancel small button"><i class="ui times icon"></i>{{ __("Cancel") }}</a>
                    </div>
                    </form>
                </div>
            </div>
