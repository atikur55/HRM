...
<html lang="en">
  ...
  <body>
    @php
    $get_employee = App\User::where('reference',$payroll_info->reference)->first();
    @endphp
        ...
        <div class="col-lg-12">
          <table class="table table-bordered text-cente">
            ...
            <tr>
              ...
              <td style="font-size:15px;font-family:Times New Roman;">{{$payroll_info->salary??'0'}}</td>
              <td style="font-size:15px;font-family:Times New Roman;">Deduction</td>
              <td style="font-size:15px;font-family:Times New Roman;">{{$payroll_info->deduction??'0'}}</td>
            </tr>
            <tr>
              <td style="font-size:15px;font-family:Times New Roman;">Bonous</td>
              <td style="font-size:15px;font-family:Times New Roman;">{{$payroll_info->bonus??'0'}}</td>
              <td style="font-size:15px;font-family:Times New Roman;"></td>
              <td style="font-size:15px;font-family:Times New Roman;"></td>
            </tr>
            <tr>
              <td style="font-size:15px;font-family:Times New Roman;">Allowance</td>
              <td style="font-size:15px;font-family:Times New Roman;">{{$payroll_info->allowance??'0'}}</td>
              <td style="font-size:15px;font-family:Times New Roman;"></td>
              <td style="font-size:15px;font-family:Times New Roman;"></td>
            </tr>
            <tr>
              <td style="font-size:15px;font-family:Times New Roman;">Total Addition</td>
              <td style="font-size:15px;font-family:Times New Roman;">{{$payroll_info->salary+$payroll_info->bonus+$payroll_info->allowance}} Tk</td>
            ...
            <tr>
              ...
              <td style="font-size:15px;font-family:Times New Roman;">{{$payroll_info->salary+$payroll_info->bonus+$payroll_info->allowance-$payroll_info->deduction}}</td>
            </tr>
          </table>
        </div>
      </div>
