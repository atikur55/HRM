                                ...
                                @foreach($lg as $l)
                                    <tr>
                                        ...
                                        <td class="align-right">
                                            <a href="{{ url('fields/leavetype/leave-groups/edit/'.$l->id) }}" class="btn btn-info ui circular basic icon button tiny"><i class="fa fa-edit"></i></a>
                                            <a href="{{ url('fields/leavetype/leave-groups/delete/'.$l->id) }}" class="btn btn-danger ui circular basic icon button tiny"><i class="fa fa-trash"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                            @endisset
