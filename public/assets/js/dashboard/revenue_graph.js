...
function expGraph(expRes){
  ...
  */
  ...
  console.log('options1.series.data = ') ;
  console.log( options1.series[0].data ) ;
  new_data = options1.series[0].data 

  if(chart1.render())   console.log('i am rendering...') ;

// if(chart1.render())   console.log('i am rendering...') ;
  
 
  old_data = options1.series[0].data 
